...
import { Box, Typography, Button, CircularProgress, Paper, Alert, TextField, List, ListItem, ListItemText, Chip } from '@mui/material';
import ArrowBackIcon from '@mui/icons-material/ArrowBack';
import { runSymptomChecker } from '../../services/geminiService';
import { SymptomCheckerResult } from '../../types';

interface SymptomCheckerModuleProps {
  onBack: () => void;
}

const SymptomCheckerModule: React.FC<SymptomCheckerModuleProps> = ({ onBack }) => {
  ...
  return (
    <Paper sx={{ p: 3, borderRadius: 2 }}>
      ...
      <Typography color="text.secondary" sx={{ mb: 3 }}>
        Describe your symptoms in plain language for a preliminary AI analysis. This is not a diagnosis.
      </Typography>
